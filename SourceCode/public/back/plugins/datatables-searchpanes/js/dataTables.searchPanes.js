    ...
    var SearchPane = /** @class */ (function () {
        ...
        SearchPane.prototype._getComparisonRows = function () {
            ...
            for (var _i = 0, options_1 = options; _i < options_1.length; _i++) {
                ...
                var insert =
                    comp.label !== "" ? comp.label : this.c.emptyMessage;
                var comparisonObj = {
        ...
        SearchPane.prototype._updateCommon = function (draw) {
            ...
            if (
                ...
                var selected = this.s.dtPane
                    ...
                    .data()
                    .toArray();
                var scrollTop = $(this.s.dtPane.table().node()).parent()[0]
                    .scrollTop;
                var rowData = this.s.rowData;
                ...
                if (this.colExists) {
                    ...
                    var _loop_1 = function (dataP) {
                        ...
                        if (
                            ...
                            var selectIndex = selected.findIndex(function (
                                element
                            ) {
