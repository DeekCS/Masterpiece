        ...
        (modules = [
            ...
            function (module, exports, __webpack_require__) {
                ...
                var _mask = __webpack_require__(11),
                    ...
                    _definitions = _interopRequireDefault(
                ...
                (Inputmask.prototype = {
                    ...
                    mask: function mask(elems) {
                        ...
                        return (
                            ...
                            elems.forEach(function (el, ndx) {
                                var scopedOpts = _inputmask.default.extend(
                                    !0,
                                    {},
                                    that.opts
                                );
                                if (
                                    ...
                                    var maskset = (0,
                                    _maskLexer.generateMaskSet)(
                                        scopedOpts,
                                        that.noMasksCache
                                    );
                                    void 0 !== maskset &&
                                        (void 0 !== el.inputmask &&
                                            ((el.inputmask.opts.autoUnmask =
                                                !0),
                                            el.inputmask.remove()),
                    ...
                    isValid: function isValid(value) {
                        ...
                        for (
                            var buffer = _positioning.getBuffer.call(this),
                                rl =
                                    _positioning.determineLastRequiredPosition.call(
                                        this
                                    ),
                    ...
                    setValue: function setValue(value) {
                        this.el &&
                            (0, _inputmask.default)(this.el).trigger(
                                "setvalue",
                                [value]
                            );
                    },
                        ...
                        "string" == typeof elems &&
                            ...
                            elems.forEach(function (el) {
                                el.inputmask
                                    ...
                                    : (0, _inputmask.default)(el).trigger(
                                          "setvalue",
                                          [value]
                                      );
                            });
            ...
            function (module, exports, __webpack_require__) {
                ...
                Object.defineProperty(exports, "__esModule", {
                    ...
                    (exports.determineNewCaretPosition =
                        ...
                        return (
                                  ...
                                  (end = begin + range.text.length)),
                            {
                                begin: notranslate
                                    ...
                                    ? end
                                    : translatePosition.call(this, end),
                            }
                        );
                    if (
                        (Array.isArray(begin) &&
                        ...
                        if (
                            ...
                            opts.insertModeVisual &&
                                ...
                                (isDelete || end++),
                            input ===
                                (input.inputmask.shadowRoot || document)
                                    .activeElement)
                        )
                ...
                function determineLastRequiredPosition(returnDefinition) {
                    var inputmask = this,
                        ...
                        ndxIntlzr =
                            void 0 !== lvTest ? lvTest.locator.slice() : void 0,
                        testPos;
                            ...
                            (lvTestAlt &&
                                ((lvTestAlt !==
                                    ...
                                    (!0 === testPos.match.static &&
                                        ...
                                        "" !==
                                            _validationTests.getTests.call(
                                                this,
                                                pos
                                            )[0].def)))) &&
                            buffer[pos] ===
                            ...
                            default:
                                ...
                                if (clickPosition <= lastPosition)
                                    ...
                                    var lvp =
                                        ...
                                        tt =
                                            _validationTests.getTestTemplate.call(
                                                inputmask,
                                                lastPosition,
                                                lvp
                                                    ? lvp.match.locator
                ...
                function getBuffer(noCache) {
                    ...
                    return (
                        (void 0 !== maskset.buffer && !0 !== noCache) ||
                            ((maskset.buffer =
                                _validationTests.getMaskTemplate.call(
                                    this,
                                    !0,
                                    getLastValidPosition.call(this),
                                    !0
                ...
                function isMask(pos, strict, fuzzy) {
                    var inputmask = this,
                        maskset = this.maskset,
                        test = _validationTests.getTestTemplate.call(
                            this,
                            pos
                        ).match;
                    if (
                        ("" === test.def &&
                            (test = _validationTests.getTest.call(
                                this,
                                pos
                            ).match),
                        !0 !== test.static)
                    ...
                    if (!0 !== strict && -1 < pos) {
                        if (fuzzy) {
                            var tests = _validationTests.getTests.call(
                                this,
                                pos
                            );
                            return (
                        ...
                        var testTemplate =
                                _validationTests.determineTestTemplate.call(
                                    this,
                                    pos,
                ...
                function seekNext(pos, newBlock, fuzzy) {
                    ...
                    for (
                        ...
                        ((!0 === newBlock &&
                            (!0 !==
                                _validationTests.getTest.call(this, position)
                                    .match.newBlockMarker ||
                                !isMask.call(this, position, void 0, !0))) ||
                            (!0 !== newBlock &&
                                !isMask.call(this, position, void 0, fuzzy)));
                    ...
                    function resolveTestFromToken(
                        ...
                        function handleMatch(
                            ...
                            function isSameLevel(targetMatch, altMatch) {
                                if (
                                    targetMatch.locator.length !==
                                    altMatch.locator.length
                                )
                                    return !1;
                                for (
                                    ...
                                    if (
                                        targetMatch.locator[locNdx] !==
                                        altMatch.locator[locNdx]
                                    )
                                        return !1;
                                return !0;
                            }
                            ...
                            if (void 0 !== match.matches) {
                                if (
                                    ...
                                    quantifierRecurse !==
                                        maskToken.matches[
                                            maskToken.matches.indexOf(match) - 1
                                        ]
                                )
                                    for (
                                        var qt = match,
            ...
            function (module, exports, __webpack_require__) {
                ...
                function alternate(
                    ...
                    if (
                        ...
                        (lastAlt = 0),
                            (prevAltPos = _validationTests.getTest.call(
                                this,
                                lastAlt
                            )),
                        ...
                        (decisionPos = parseInt(lastAlt)),
                            ...
                            !0 !== maskPos &&
                                maskset.excludes[decisionPos].push(
                                    (0, _validationTests.getDecisionTaker)(
                                        prevAltPos
                                    ) +
                                        ":" +
                ...
                function handleRemove(input, k, pos, strict, fromIsValid) {
                    ...
                    if (
                        ...
                        k === _keycode.default.BACKSPACE
                            ...
                            : k === _keycode.default.DELETE &&
                              pos.begin === pos.end &&
                              (pos.end = _positioning.isMask.call(
                                  this,
                                  pos.end,
                                  !0,
                                  !0
                                  ...
                                  ? pos.end + 1
                                  : _positioning.seekNext.call(this, pos.end) +
                                    1),
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    result = {
                                        caret: _positioning.seekNext.call(
                                            inputmask,
                                            maskPos
                                        ),
                                    };
                ...
                function trackbackPositions(originalPos, newPos, fillOnly) {
                    ...
                    for (var ps = originalPos; ps < newPos; ps++)
                        if (
                            ...
                            if (vp) {
                                var tests = _validationTests.getTests
                                    .call(this, ps)
                                    .slice();
                                "" === tests[tests.length - 1].match.def &&
                                    tests.pop();
                                ...
                                if (
                                    ...
                                    var cvpInput =
                                        maskset.validPositions[newPos].input;
                                    return (
                ...
                function revalidateMask(
                    ...
                    if (
                        ...
                        (validatedPos =
                            void 0 !== validatedPos ? validatedPos : begin),
                        begin !== end ||
                            (opts.insertMode &&
                                void 0 !==
                                    maskset.validPositions[validatedPos] &&
                                void 0 === fromIsValid) ||
                            void 0 === validTest)
                    ) {
                        var positionsClone = $.extend(
                            ...
                            lvp = _positioning.getLastValidPosition.call(
                                this,
                                void 0,
                                !0
                            ),
                            ...
                            if (
                                ...
                                for (
                                    ...
                                    if (
                                        !1 !==
                                            (canMatch =
                                                positionCanMatchDefinition.call(
                                                    this,
                                                    posMatch,
                                                    t,
                                                    opts
                        ...
                        validTest &&
                            _validationTests.getTest.call(this, validatedPos)
                                .match.cd === validTest.match.cd &&
            ...
            function (module, exports, __webpack_require__) {
                ...
                function checkVal(
                    ...
                    function isTemplateMatch(ndx, charCodes) {
                        for (
                            var targetTemplate =
                                    _validationTests.getMaskTemplate
                                        .call(inputmask, !0, 0)
                                        .slice(
                                            ndx,
                                            _positioning.seekNext.call(
                            ...
                            (_validationTests.getTest.call(inputmask, ndx).match
                                ...
                                (" " ===
                                    ...
                                    (_validationTests.getTest.call(
                                        inputmask,
                                        ndx + 1
                                    ).match.nativeDef === charCodes.charAt(0) ||
                                        (!0 ===
                                            _validationTests.getTest.call(
                                                inputmask,
                                                ndx + 1
                        ...
                        if (
                            ...
                            var nextPos = _positioning.seekNext.call(
                                inputmask,
                                ndx
                            );
                    ...
                    if (
                        ...
                        var sndx,
                            validPos,
                            nextValid = _positioning.seekNext.call(
                                inputmask,
                                -1,
                                void 0,
                                !1
                ...
                function HandleNativePlaceholder(npt, value) {
                    ...
                    if (_environment.ie) {
                        if (
                            ...
                            var buffer = _positioning.getBuffer
                                    .call(inputmask)
                                    .slice(),
                        ...
                        if (result) {
                            if (result.refreshFromBuffer) {
                                ...
                                _validation.refreshFromBuffer.call(
                                    ...
                                    (buffer = _positioning.getBuffer.call(
                                        inputmask,
                                        !0
                                    ));
                            }
                ...
                var EventHandlers = {
                        ...
                        if (
                            ...
                            k === _keycode.default.PAGE_UP
                                ...
                                ? ((0, _inputHandling.checkVal)(
                                  ...
                                  $input.trigger("click"))
                                : !0 === opts.tabThrough &&
                                  k === _keycode.default.TAB
                                ? !0 === e.shiftKey
                                    ? ((pos.end =
                                          _positioning.seekPrevious.call(
                                              inputmask,
                                              pos.end,
                                              !0
                                          )),
                    ...
                    keypressEvent: function keypressEvent(
                        ...
                        if (k) {
                            ...
                            if (
                                (!1 !== valResult &&
                                    (_positioning.resetMaskSet.call(
                                        inputmask,
                                        !0
                                    ),
                                    (forwardPosition =
                    ...
                    inputFallBackEvent: function inputFallBackEvent(e) {
                        ...
                        function analyseChanges(inputValue, buffer, caretPos) {
                            ...
                            var newBuffer = frontPart.concat(backPart),
                                oldBuffer =
                                    frontBufferPart.concat(backBufferPart);
                        ...
                        if (buffer !== inputValue) {
                            ...
                            switch (
                                ((input.inputmask.shadowRoot || document)
                                    .activeElement !== input && input.focus(),
                                (0, _inputHandling.writeBuffer)(
                                    input,
                                    _positioning.getBuffer.call(inputmask)
                                ),
                ...
                function mask() {
                                    ...
                                    $.valHooks[type] = {
                                        ...
                                        set: function set(elem, value) {
                                            ...
                                            return (
                                                elem.inputmask &&
                                                    (0,
                                                    _inputHandling.applyInputValue)(
                                                        elem,
                                                        value
                                                    ),
                                                result
                        ...
                        var elementType = input.getAttribute("type"),
                            isSupported =
                                ("input" === input.tagName.toLowerCase() &&
                                    opts.supportsInputType.includes(
                                        elementType
                                    )) ||
                    ...
                    if (!1 !== isSupported) {
                        (inputmask.originalPlaceholder = el.placeholder),
                            ...
                            -1 === inputmask.maxLength &&
                                (inputmask.maxLength = void 0),
                            "inputMode" in el &&
                            ...
                            (inputmask.undoValue =
                                _positioning.getBufferTemplate
                                    ...
                                    .join(""));
                        var activeElement = (
                            el.inputmask.shadowRoot || document
                        ).activeElement;
                        if (
                        ...
                        var $ = input.inputmask.dependencyLib,
                            ev = function ev(e) {
                                ...
                                if (
                                    ...
                                    $(that).off(),
                                        imOpts &&
                                            new _inputmask.default(imOpts).mask(
                                                that
                                            );
                                } else {
                                    if (
                                                ...
                                                return (
                                                    inputmask.validationEvent
                                                        ? ((inputmask.validationEvent =
                                                          ...
                                                          input.blur(),
                                                          (0,
                                                          _inputHandling.HandleNativePlaceholder)(
                                                              input,
                                                              (inputmask.isRTL
                                                                  ? _positioning.getBufferTemplate
                                                                        .call(
            ...
            function (module, exports, __webpack_require__) {
                ...
                var _inputmask2 = _interopRequireDefault(
                        ...
                        if (ev in eventRegistry == !0)
                            if (
                                ...
                                eventRegistry[ev][namespace].splice(
                                    eventRegistry[ev][namespace].indexOf(
                                        handler
                                    ),
                                    1
                                );
                        ...
                        if (0 < ev.length)
                            if (void 0 === handler)
                                for (
                                    hndx = 0,
                                        hndL =
                                            eventRegistry[ev][namespace].length;
                                    hndx < hndL;
                                    hndx++
                                )
                                    evts.push({
                                        ...
                                        namespace:
                                            namespace && 0 < namespace.length
                                                ...
                                                : "global",
                                        handler:
                                            eventRegistry[ev][namespace][hndx],
                                    });
                            else
                                evts.push({
                                    ev: ev,
            ...
            function (module, exports, __webpack_require__) {
                ...
                var _inputmask = _interopRequireDefault(__webpack_require__(1)),
                    _keycode = _interopRequireDefault(__webpack_require__(0)),
                    _escapeRegex = _interopRequireDefault(
                ...
                function prefillYear(dateParts, currentResult, opts) {
                    if (dateParts.year !== dateParts.rawyear) {
                        var crrntyear = currentYear.toString(),
                            enteredPart = dateParts.rawyear.replace(
                                /[^0-9]/g,
                                ""
                            ),
                            currentYearPart = crrntyear.slice(
                                0,
                                enteredPart.length
                            ),
                            currentYearNextPart = crrntyear.slice(
                                enteredPart.length
                            );
                        if (
                            2 === enteredPart.length &&
                            enteredPart === currentYearPart
                        ) {
                        ...
                        postValidation: function postValidation(
                            ...
                            if (!1 === currentResult)
                                return (
                                    ...
                                    1 < tokenMatch.targetMatch[0].length &&
                                    void 0 !==
                                        formatCode[tokenMatch.targetMatch[0]] &&
                                    ((validator =
                                        formatCode[
                                            tokenMatch.targetMatch[0]
                                        ][0]),
                            ...
                            if (
                                ...
                                validator =
                                    formatCode[tokenMatch.targetMatch[0]][0];
            ...
            function (module, exports, __webpack_require__) {
                ...
                function alignDigits(buffer, digits, opts, force) {
                    ...
                    return (
                        negationBack && buffer.push(opts.negationSymbol.back),
                        buffer
                    );
                }
                ...
                function genMask(opts) {
                        ...
                        ? ((decimalDef = "1"),
                          ...
                          "" !== opts.radixPoint &&
                              ...
                              (opts.definitions[radixPointDef].validator =
                                  "[" + opts.radixPoint + "]"),
                              (opts.definitions[radixPointDef].placeholder =
                                  opts.radixPoint),
                    ...
                    return (
                        ...
                        altMask &&
                            (mask = [
                                altMask + autoEscape(opts.suffix, opts) + "[-]",
                                mask,
                            ]),
                        (opts.greedy = !1),
                ...
                _inputmask.default.extendAliases({
                    numeric: {
                        ...
                        preValidation: function preValidation(
                            ...
                            var pattern;
                            if (
                                (pattern = opts.shortcuts && opts.shortcuts[c])
                            ) {
                                if (1 < pattern.length)
                                    for (
                                        var inserts = [], i = 0;
                        ...
                        onKeyDown: function onKeyDown(
                            ...
                            if (
                                ...
                                (e.keyCode === _keycode.default.DELETE ||
                                    ...
                                    e.keyCode ===
                                        _keycode.default.BACKSPACE_SAFARI) &&
            ...
            function (module, exports, __webpack_require__) {
                ...
                if (
                    ...
                    _window.default.customElements.define(
                        "input-mask",
                        InputmaskElement
                    );
                }
