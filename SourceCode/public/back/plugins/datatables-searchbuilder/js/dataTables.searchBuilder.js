(function () {
        ...
        $.extend(DateTime.prototype, {
                    ...
                    .on("click", function (e) {
                        ...
                        if (nodeName === "button") {
                            ...
                            if (parent.hasClass(classPrefix + "-iconLeft")) {
                                ...
                                button.parents("." + classPrefix + "-time")
                                    .length
                            ) {
            ...
            _optionsTime: function (unit, count, val, allowed, range) {
                ...
                if (count === 12) {
                    ...
                    var start =
                        range !== null ? range : Math.floor(val / 10) * 10;
    ...
    var Criteria = /** @class */ (function () {
        ...
        Criteria.prototype.setListeners = function () {
            ...
            $(this.dom.data)
                ...
                .on("input change", function () {
                    ...
                    _this.s.dataIdx = $(_this.dom.data)
                        .children("option:selected")
                        .val();
                    _this.s.data = $(_this.dom.data)
                        .children("option:selected")
                        .text();
        ...
        Criteria.prototype._adjustCriteria = function () {
            ...
            var hasRight =
                $(this.dom.container).has(this.dom.right).length !== 0;
            ...
            if (this.s.dataPoints.length === 0) {
                this.s.dt.columns().every(function (index) {
                    ...
                    if (
                        ...
                        if (!found) {
                            var opt = {
                                text: _this.s.dt.settings()[0].aoColumns[index]
                                    .sTitle,
                                index: index,
                            };
            ...
            contains: {
                ...
                search: function (value, comparison) {
                    return (
                        value
                            .toLowerCase()
                            .indexOf(comparison[0].toLowerCase()) !== -1
                    );
                },
            },
            ends: {
    ...
    var Group = /** @class */ (function () {
        ...
        Group.prototype.setupLogic = function () {
            ...
            $$1(this.dom.clear).outerHeight(
                $$1(this.dom.logicContainer).height()
            );
    ...
    var SearchBuilder = /** @class */ (function () {
        ...
        SearchBuilder.prototype._setUp = function (loadState) {
            ...
            if (loadState) {
                ...
                if (
                    ...
                    $$2(this.s.topGroup.dom.container).trigger(
                        "dtsb-redrawContents"
                    );
        ...
        SearchBuilder.prototype._build = function () {
            ...
            this.s.dt.on("destroy.dt", function () {
                ...
                var searchIdx = $$2.fn.dataTable.ext.search.indexOf(
                    _this.s.search
                );
                while (searchIdx !== -1) {
                    $$2.fn.dataTable.ext.search.splice(searchIdx, 1);
                    searchIdx = $$2.fn.dataTable.ext.search.indexOf(
                        _this.s.search
                    );
                }
            });
        ...
        SearchBuilder.prototype._setRedrawListener = function () {
            ...
            $$2(this.s.topGroup.dom.container).on(
                "dtsb-redrawContents",
                function () {
                    _this._checkClear();
