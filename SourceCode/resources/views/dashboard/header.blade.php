    ...
    <nav class="mt-2">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{url('dashboard/categories/add')}}" class="nav-link">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a href="{{url('dashboard/courses/add')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Add Course</p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{url('dashboard/courses')}}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Show Courses</p>
                    </a>
                </li>
